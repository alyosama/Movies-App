...
public class FetchVideosTask extends AsyncTask<MovieContent.Movie, Void, List<MovieContent.Video>> {
    private final String LOG_TAG = FetchVideosTask.class.getSimpleName();
    private VideoAdapter mVideoAdapter;

    public FetchVideosTask(VideoAdapter mVideoAdapter) {
        this.mVideoAdapter = mVideoAdapter;
    }


    @Override
    protected List<MovieContent.Video> doInBackground(MovieContent.Movie... params) {
        ...
        try {
            final String REVIEW_BASE_URL = "http://api.themoviedb.org/3/movie/" + params[0].getId() + "/videos?";
